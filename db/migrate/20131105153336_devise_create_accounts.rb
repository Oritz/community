class DeviseCreateAccounts < ActiveRecord::Migration
  def change
    create_table(:accounts) do |t|
      ...
      t.column :account_type, :smallint, :null => false, :defualt => 0
      t.integer :follower_count, :null => false, :default => 0
      t.integer :following_count, :null => false, :default => 0
      t.integer :talk_count, :null => false, :default => 0
      t.integer :subject_count, :null => false, :default => 0
      t.integer :recommend_count, :null => false, :default => 0

      t.column :nick_name, :string, :limit => 64, :null => false
      t.column :gender, :tinyint, :null => false
      t.column :avatar, :string, :limit => 255, :default => ""
